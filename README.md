...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/artisticjammer
```

A live public deployment of this template is available at [https://artisticjammer.templates.workers.dev](https://artisticjammer.templates.workers.dev)
